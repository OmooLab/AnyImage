"""Polygonal chain simplification using NumPy."""

import numpy as np


# approximate_polygon: scikit-image 0.25.2, copyright 2009-2022 the scikit-image team.
# BSD-3-Clause; see ../../licenses/scikit-image.txt.
